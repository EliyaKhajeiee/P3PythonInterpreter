...
def make_test_lines() -> list[TestInputLine | TestOutputLine]:
    return [
        ...
        TestInputLine('PRINT D'),  # D = 1
        TestInputLine('GOTO 2'),  # test goto
        TestInputLine('LET D 2'),  # this line is skipped
        TestInputLine('PRINT D'),  # D = 1

        # 7: INPUT - GOSUB
        TestInputLine('        LET AA 3'),
        TestInputLine('        PRINT AA'),
        TestInputLine('        GOSUB "CHUNK"'),
        TestInputLine('        PRINT AA'),
        TestInputLine('        PRINT BB'),
        TestInputLine('        GOTO "FINAL"'),
        TestInputLine('CHUNK:  LET AA 4'),
        TestInputLine('        LET BB 6'),
        TestInputLine('        RETURN'),
        TestInputLine('FINAL:  PRINT AA'),
        ...
        # 12: INPUT - GOTO
        TestInputLine('LET Z12 6'),  # 1 - start here
        TestInputLine('GOTO 5'),  # 2 (jump)
        TestInputLine('LET C12 4'),  # 6 (jumped from 5)
        TestInputLine('PRINT C12'),  # 7
        TestInputLine('PRINT Z12'),  # 8
        TestInputLine('GOTO 4'),  # 9 (jump to line after 5 - #13: INPUT)
        TestInputLine('PRINT C12'),  # 3 (jumped from 2)
        TestInputLine('PRINT Z12'),  # 4
        TestInputLine('GOTO -6'),  # 5 (jump)

        # 13: INPUT - GOTO string
        TestInputLine('PRINT "NEW GOTO TEST"'),
        TestInputLine('LET Z 5'),
        TestInputLine('PRINT "Z=5"'),
        TestInputLine('GOTO "CZ1"'),
        TestInputLine('CCZ: LET C 4'),
        TestInputLine('PRINT C'),
        TestInputLine('PRINT Z'),
        TestInputLine('GOTO 5'),
        TestInputLine('CZ1: PRINT C'),
        TestInputLine('PRINT "Z="'),
        TestInputLine('PRINT Z'),
        TestInputLine('GOTO "CCZ"'),

        # 14: INPUT - GOTO variable
        TestInputLine('        LET Z14 1'),
        TestInputLine('        LET C14 11'),
        TestInputLine('        LET F14 4'),
        TestInputLine('        LET B14 "ZC"'),
        TestInputLine('        GOTO F14'),
        TestInputLine('ZC:     PRINT Z14'),
        TestInputLine('        PRINT C14'),
        TestInputLine('GOTO 6'),
        TestInputLine('CZ:     PRINT C14'),
        TestInputLine('        PRINT Z14'),
        TestInputLine('        LET Z14 50'),
        TestInputLine('        LET C14 100'),
        TestInputLine('        GOTO B14'),

        # 15: INPUT - GOSUB
        TestInputLine('LET A15 1'),
        TestInputLine('GOSUB 4'),
        TestInputLine('PRINT A15'),
        TestInputLine('PRINT B15'),
        TestInputLine('GOTO 4'),
        TestInputLine('LET A15 2'),
        TestInputLine('LET B15 3'),
        TestInputLine('RETURN'),

        # 16: INPUT - GOSUB
        TestInputLine('           LET A16 3'),
        TestInputLine('           GOSUB "PRINTABC"'),
        TestInputLine('           LET B16 4'),
        TestInputLine('           GOSUB "PRINTABC"'),
        TestInputLine('           LET C16 5'),
        TestInputLine('           GOSUB "PRINTABC"'),
        TestInputLine('           LET A16 1'),
        TestInputLine('           GOSUB "PRINTABC"'),
        TestInputLine('GOTO 5'),
        TestInputLine('PRINTABC:  PRINT A16'),
        TestInputLine('           PRINT B16'),
        TestInputLine('           PRINT C16'),
        TestInputLine('           RETURN'),

        # 17: INPUT - GOSUB
        TestInputLine('LET A17 1'),    # 1 - start here
        TestInputLine('GOSUB 5'),      # 2 (jump)
        TestInputLine('PRINT A17'),    # 11 (returned from 8) (fourth output: print 3)
        TestInputLine('GOTO 9'),       # 12 (jump)
        TestInputLine('LET A17 3'),    # 7
        TestInputLine('RETURN'),       # 8 - return to after 6 (most recent gosub)
        TestInputLine('PRINT A17'),    # 3 (first output: print 1)
        TestInputLine('LET A17 2'),    # 4
        TestInputLine('PRINT A17'),    # 5 (second output: print 2)
        TestInputLine('GOSUB -5'),     # 6 (jump)
        TestInputLine('PRINT A17'),    # 9 (returned from 11) (third output: print 3)
        TestInputLine('RETURN'),       # 10 - return to after 2 (remaining gosub)

        # 18: INPUT - arithmetic
        TestInputLine('LET A18 4'),
        TestInputLine('ADD A18 3'),
        TestInputLine('PRINT A18'),
        TestInputLine('LET B18 5'),
        TestInputLine('SUB B18 3'),
        TestInputLine('PRINT B18'),
        TestInputLine('LET C18 6'),
        TestInputLine('MULT C18 B18'),
        TestInputLine('PRINT C18'),
        TestInputLine('LET D18 8'),
        TestInputLine('DIV D18 2'),
        TestInputLine('PRINT D18'),

        # 19: INPUT - conditional GOTO
        TestInputLine('LET A19 3'),
        TestInputLine('LET B19 5'),
        TestInputLine('GOTO 2 IF A19 < 4'),
        TestInputLine('PRINT A19'),
        TestInputLine('PRINT B19'),
        TestInputLine('PRINT "END OF PROGRAM"'),
        ...
        # 13: OUTPUT - GOTO string
        TestOutputLine('NEW GOTO TEST', 100.0),
        TestOutputLine('Z=5', 100.0),
        TestOutputLine('0', 100.0),
        TestOutputLine('Z=', 100.0),
        TestOutputLine('5', 100.0),
        TestOutputLine('4', 100.0),
        TestOutputLine('5', 100.0),

        # 14: OUTPUT - GOTO variable
        TestOutputLine('11', 100.0),
        TestOutputLine('1', 100.0),
        TestOutputLine('50', 100.0),
        TestOutputLine('100', 100.0),
        ...
        # 18: OUTPUT - arithmetic
        TestOutputLine('7', 100.0),
        TestOutputLine('2', 100.0),
        TestOutputLine('12', 100.0),
        TestOutputLine('4', 100.0),

        # 19: INPUT - conditional GOTO
        TestOutputLine('5', 100.0),
        TestOutputLine('END OF PROGRAM', 100.0),
